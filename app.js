...
inputQuantity.addEventListener('keyup',()=>{
    ...
    if(inputQuantity.value === '' && inputRate.value !== '' || inputQuantity.value === '' && inputRate.value === ''){
        
        inputBeforeAmount.value = amountBefore
    } else if(inputQuantity.value !=='' && inputRate.value !== ''){
        amountBefore = parseInt(inputQuantity.value) * parseInt(inputRate.value)
        inputBeforeAmount.value = amountBefore
    }
})
...
inputRate.addEventListener('keyup',()=>{
    ...
    if (inputRate.value === '' && inputQuantity.value === '' || inputRate.value === '' && inputQuantity.value !== ''){
        inputBeforeAmount.value = amountBefore
